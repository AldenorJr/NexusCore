...
public class Spigot extends JavaPlugin {
    ...
    private final EconomyCommand economyCommand = new EconomyCommand(economy);
    ...
    public void loadRanking() {
        Bukkit.getScheduler().scheduleSyncRepeatingTask(this, economyRanking::LoadRanking, 0, 20 * 60 * 5);
    }
